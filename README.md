...
In the _rasp_ folder we have scripts for conducting experiment runs on the Raspberry Pi 4:  
- **bench_second.sh** -- a bash script for running the full grid of tests
- **ollama_raspberry_test.py** -- the python script for running the models 
